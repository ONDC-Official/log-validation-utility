export const onCancelSchemaFIS10 = {
      ...
      "message": {
        ...
        "properties": {
          "order": {
            ...
            "properties": {
              ...
              "cancellation": {
                ...
                "properties": {
                  ...
                  "reason": { "type": "object", "properties": { "id": { "type": "string" } }, "required": ["id"] }
                },
                ...
                "items": {
                  ...
                  "properties": {
                    ...
                    "state": {
                      "type": "object",
                      "properties": {
                        "descriptor": { "type": "object", "properties": { "code": { "type": "string", "enum": ["CANCELLED"] } }, "required": ["code"] }
                      },
                      "required": ["descriptor"]
                    },
                    "type": { "type": "string" },
            ...
            "required": ["id", "status", "cancellation", "provider", "items", "fulfillments", "billing", "quote"]
          }
        },
        "required": ["order"]
      }
