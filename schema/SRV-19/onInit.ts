export const onInitSchemaSRV19 = {
    "type": "object",
    ...
    "properties": {
      ...
      "message": {
        ...
        "properties": {
          "order": {
            "type": "object",
            "required": ["provider", "items", "billing", "fulfillments", "quote", "payments"],
            "properties": {
              "provider": {
                "type": "object",
              ...
              "items": {
                ...
                "items": {
                  "type": "object",
                  "required": ["id", "location_ids", "fulfillment_ids"], // Removed quantity from required
                  "properties": {
                    "id": { "type": "string" },
                    "location_ids": {
                      "type": "array",
                  ...
                  "breakup": {
                    ...
                    "items": {
                      ...
                      "properties": {
                        ...
                        "item": {
                          "type": "object",
                          "required": ["id"], // Removed quantity and price from required
                          "properties": {
                            "id": { "type": "string" },
                            "quantity": {
                              "type": "object",
