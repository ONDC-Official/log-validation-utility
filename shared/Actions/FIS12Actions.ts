...
export function validateLogsForFIS12(data: any, flow: string, version: string) {
  ...
  try {
    ...
    case FisWCLApiSequence.ON_STATUS_KYC:
      return checkon_statusWCL(data[FisWCLApiSequence.ON_STATUS_KYC], msgIdSet, flow, FisWCLApiSequence.ON_STATUS_KYC)
    case FisWCLApiSequence.ON_STATUS_EKYC:
      return checkon_statusWCL(data[FisWCLApiSequence.ON_STATUS_EKYC], msgIdSet, flow, FisWCLApiSequence.ON_STATUS_EKYC)
    case FisWCLApiSequence.ON_STATUS_ESIGN:
      return checkon_statusWCL(data[FisWCLApiSequence.ON_STATUS_ESIGN], msgIdSet, flow, FisWCLApiSequence.ON_STATUS_ESIGN)
    case FisWCLApiSequence.ON_STATUS_EMANDATE:
      return checkon_statusWCL(data[FisWCLApiSequence.ON_STATUS_EMANDATE], msgIdSet,flow,FisWCLApiSequence.ON_STATUS_EMANDATE)
    ...
    case FisWCLApiSequence.ON_UPDATE_EMI_DETAIL:
      return checkon_updateWCL(data[FisWCLApiSequence.ON_UPDATE_EMI_DETAIL], msgIdSet, flow, FisWCLApiSequence.ON_UPDATE_EMI_DETAIL)
    case FisWCLApiSequence.ON_UPDATE_PRE_PART_PAYMENT:
      return checkon_updateWCL(data[FisWCLApiSequence.ON_UPDATE_PRE_PART_PAYMENT], msgIdSet, flow, FisWCLApiSequence.ON_UPDATE_PRE_PART_PAYMENT)
    case FisWCLApiSequence.ON_UPDATE_FORECLOSURE_DETAIL:
      return checkon_updateWCL(data[FisWCLApiSequence.ON_UPDATE_FORECLOSURE_DETAIL], msgIdSet, flow, FisWCLApiSequence.ON_UPDATE_FORECLOSURE_DETAIL)
    case FisWCLApiSequence.ON_UPDATE_BASE_TRANSACTION:
      return checkon_updateWCL(data[FisWCLApiSequence.ON_UPDATE_BASE_TRANSACTION], msgIdSet, flow, FisWCLApiSequence.ON_UPDATE_BASE_TRANSACTION)
    case FisWCLApiSequence.ON_UPDATE_UNSOLICATED:
      return checkon_updateWCL(data[FisWCLApiSequence.ON_UPDATE_UNSOLICATED], msgIdSet, flow, FisWCLApiSequence.ON_UPDATE_UNSOLICATED)
    case FisWCLApiSequence.ON_UPDATE_PAYMENT_STATUS:
      return checkon_updateWCL(data[FisWCLApiSequence.ON_UPDATE_PAYMENT_STATUS], msgIdSet, flow, FisWCLApiSequence.ON_UPDATE_PAYMENT_STATUS)
        default:
          return null
      }
    }
