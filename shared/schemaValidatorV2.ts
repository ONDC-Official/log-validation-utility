...
import { FnBselectSchema } from '../schema/Retail_1.2.5/RET11/select'

import { FnBsearchSchema } from '../schema/Retail_1.2.5/RET11/search'
import { FnBonSearchSchema } from '../schema/Retail_1.2.5/RET11/on_search'
import { FnBonSelectSchema } from '../schema/Retail_1.2.5/RET11/on_select'
import { FnBinitSchema } from '../schema/Retail_1.2.5/RET11/init'
import { FnBonInitSchema } from '../schema/Retail_1.2.5/RET11/on_init'
import { FnBconfirmSchema } from '../schema/Retail_1.2.5/RET11/confirm'
import { FnBonConfirmSchema } from '../schema/Retail_1.2.5/RET11/on_confirm'
import { cancelSchema } from '../schema/Retail_1.2.5/Cancel/cancel'
import { onCancelSchema } from '../schema/Retail_1.2.5/Cancel/onCancel'
import { status_cancel_RTO_Schema } from '../schema/Retail_1.2.5/Cancel/on_cancel_rto'
import { statusSchema } from '../schema/Retail_1.2.5/Status/status'
import { onStatusSchema } from '../schema/Retail_1.2.5/Status/on_status'
import { onTrackSchema } from '../schema/Retail_1.2.5/Track/on_track'
import { trackSchema } from '../schema/Retail_1.2.5/Track/track'
import { FnBonSearchIncSchema } from '../schema/Retail_1.2.5/RET11/on_search_inc'
import { searchSchema } from '../schema/Retail_1.2.5/RET/search'
import { onSearchSchema } from '../schema/Retail_1.2.5/RET/on_search'
import { selectSchema } from '../schema/Retail_1.2.5/RET/select'
import { onSelectSchema } from '../schema/Retail_1.2.5/RET/on_select'
import { initSchema } from '../schema/Retail_1.2.5/RET/init'
import { onInitSchema } from '../schema/Retail_1.2.5/RET/on_init'
import { confirmSchema } from '../schema/Retail_1.2.5/RET/confirm'
import { onConfirmSchema } from '../schema/Retail_1.2.5/RET/on_confirm'
import { catalogRejectionSchema } from '../schema/Retail_1.2.5/CatalogRejection/catalogRejection'
...
import { onSearchIncSchema } from '../schema/Retail_1.2.5/RET/on_search_inc'
import { onUpdateSchema } from '../schema/Retail_1.2.5/Update/on_update'
import { updateSchema } from '../schema/Retail_1.2.5/Update/update'
...
// Create a new Ajv instance for each validation to prevent schema caching issues
...
const validate_schema = (data: any, schema: any) => {
  ...
  // Create a fresh Ajv instance to prevent schema caching issues
