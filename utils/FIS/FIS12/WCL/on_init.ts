...
export const checkOninitWCL = (data: any, msgIdSet: any, flow: string, sequence: string) => {
  const errorObj: any = {}
  try {
    ...
    const messageIdPair = validateMessageIdPair(data.context, constants.ON_INIT, true)
