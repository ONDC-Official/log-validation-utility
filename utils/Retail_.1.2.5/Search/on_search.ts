...
import constants, { ApiSequence, offersApplicableDomains } from '../../../constants'
import {
      ...
      try {
        ...
        while (i < len) {
          ...
          try {
            ...
            // Check if media is missing or not an array
          ...
          try {
            ...
            while (j < iLen) {
              ...
              //Validating media array in bpp/providers[${i}].items[${j}]
              try {
