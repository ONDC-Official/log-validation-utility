...
export const checkUpdate = (data: any, msgIdSet: any, apiSeq: any, settlementDetatilSet: any, flow: any) => {
  ...
  try {
    ...
    try {
      ...
      if (flow === '6-b' && apiSeq == ApiSequence.UPDATE_REVERSE_QC) {
        setValue(`${ApiSequence.UPDATE_REVERSE_QC}_msgId`, data.context.message_id)
      }
      if (flow === '6-c' && apiSeq == ApiSequence.UPDATE_LIQUIDATED) {
        setValue(`${ApiSequence.UPDATE_LIQUIDATED}_msgId`, data.context.message_id)
      }
    } catch (error: any) {
              ...
              if (!isEmpty(returnFulifllmentTags?.list)) {
                ...
                if (exchangeArr.length > 0 && exchangeArr[0]?.value) {
                    ...
                    if (exchangeValue === 'yes' || exchangeValue === 'no') {
                      ...
                      if (exchangeValue === 'yes') {
                        ...
                        if (conditionIdArr.length === 0 || !conditionIdArr[0]?.value) {
                          ...
                          updtObj['returnFulfillment/code/condition_id'] =
                      ...
                      updtObj['returnFulfillment/code/exchange'] =
                  ...
                  if (ffIdArr.length > 0 && ffIdArr[0]?.value) {
                    ...
                    updtObj['returnFulfillment/code/id'] =
                  ...
                  if (replaceArr.length > 0 && replaceArr[0]?.value) {
                    ...
                    if (replaceValue === 'yes' || replaceValue === 'no') {
                      ...
                      updtObj['returnFulfillment/code/replace'] =
                  ...
                  if (itemQuantityArr.length > 0 && itemQuantityArr[0]?.value) {
                    ...
                    updtObj['returnFulfillment/code/item_quantity'] =
    ...
    try {
      ...
      logger.error(`!!Error while comparing timestamp for /${constants.ON_INIT} and /${apiSeq} api, ${error.stack}`)
    }
