...
export const checkOnStatusPayload = (data: any, msgIdSet: any) => {
  const errorObj: any = {}
  try {
    ...
    setValue(`${constants.ON_STATUS}_message`, message)
    ...
    const storedFull: any = getValue(`${constants.ON_INIT}_storedFulfillments`)
